...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 17, 2019 at 10:18 AM
...
INSERT INTO `transaction2` (`transaction2_id`, `transaction_type`, `client_id`, `mechanic_id`, `service_id`, `product_id`, `quantity`, `Total`, `date_created`, `update_stamp`) VALUES
(1, 'Walk-in', 3, 1, 1, 26, 5, 555.00, '2019-11-05 00:00:00', '2019-11-22 00:41:20');
...
--
ALTER TABLE `clients`
  MODIFY `client_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1004;
...
--
ALTER TABLE `transaction2`
  MODIFY `transaction2_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
