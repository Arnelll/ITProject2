...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 09, 2020 at 07:53 PM
...
--
ALTER TABLE `job_order`
  MODIFY `jo_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=144;

--
-- AUTO_INCREMENT for table `job_order_details`
--
ALTER TABLE `job_order_details`
  MODIFY `jodetails_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=52;
...
--
ALTER TABLE `productcheckout_details`
  MODIFY `productcheckout_details_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `product_checkout`
  MODIFY `product_checkout_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=49;
