...
<body>
        ...
        <div class="panel panel-footer">
        <?php echo Form::open(array('route'=>'checkout_insert','id'=>'formsave','method'=>'post')); ?>
            ...
            <div class="col-lg-6 col-sm-6">
                <div class="form-group">
                    <select name="joborder" id="joborder" class="form-control joborder searchable">
                        ...
                        <?php $__currentLoopData = $joborder; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($row['jo_id']); ?>"><?php echo e($row['jo_id']); ?></option>
  ...
  if($(this).val() != '')
    {
        ...
        $.ajax({
            url:"<?php echo e(route('joborder.fetch')); ?>",
            method:"POST",
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\63977\Desktop\def\ITProject2-master\finalThesis\Jeff\resources\views/dashboard/product_co.blade.php ENDPATH**/ ?>