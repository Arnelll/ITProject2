...
<body>
  ...
  <div class="col-lg-2 col-sm-2" style="margin-left:75%">
                ...
                <a href="/generate_pProfile/<?php echo e($clients->client_id); ?>/<?php echo e($jo->jo_id); ?>" class="d-inline p-2 btn btn-primary btn-lg" title="Generate Report">Generate Report</a>
        </div>
</body>
<?php $__env->stopSection(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\63977\Desktop\thesis\ITProject2\finalThesis\Jeff\resources\views/dashboard/view_service.blade.php ENDPATH**/ ?>