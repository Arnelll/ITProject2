        ...
        <div class="card-user">
          <div class="author">
            <a href="#">
              ...
              <h5 class="title"><?php echo e($result->lastname); ?>, <?php echo e($result->firstname); ?></h5>
            </a>
          </div>
        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\myker\Desktop\ITProject2-master\finalThesis\Jeff\resources\views/dashboard/view_accounts.blade.php ENDPATH**/ ?>