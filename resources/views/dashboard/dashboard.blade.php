                  ...
                  <table class="table">
                    ...
                    @foreach($result as $row)
                      <tr>
                        ...
                        <td class="text-left">Product <strong>{{$row['product_name']}}</strong> is running out (Remaining: <strong style="color:red;">{{$row['quantity']}}</strong>).</td>
                  ...
                  <table class="table">
                    ...
                    @foreach($inv as $row)
                      <tr>
                        ...
                        <td class="text-left">The Service: <strong>{{$row['service']}}</strong> has been sucessfully rendered to Mr. <strong style="color:#E2B855;">{{$row['lastname']}}, {{$row['firstname']}}.</td>
                        <td class="td-actions text-right">
